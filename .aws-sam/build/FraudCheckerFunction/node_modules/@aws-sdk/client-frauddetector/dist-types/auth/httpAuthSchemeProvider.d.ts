 ...
 * @internal
 */
export interface FraudDetectorHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<FraudDetectorClientResolvedConfig, HandlerExecutionContext, FraudDetectorHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultFraudDetectorHttpAuthSchemeParametersProvider: (config: FraudDetectorClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<FraudDetectorHttpAuthSchemeParameters>;
/**
 * @internal
 */
